...
const NAV_ITEMS: CardNavItem[] = [
  ...
  },
  {
    ...
    links: [
      ...
      {
        label: "Get the planner",
        href: "/auth/signup",
        ariaLabel: "Sign up for the planner",
      },
    ],
  },
];
  ...
  return (
    <div className="absolute inset-0">
      <Image
        ...
        alt=""
        fill
        className={`object-cover ${position} opacity-70`}
      />
...
const FEATURES = [
  {
    ...
    description:
      "No more guessing what to do. Start each day with a clear plan that tells you exactly where to focus.",
    href: "/auth/signup",
    cta: "Get started",
    className: "col-span-3 lg:col-span-2",
    background: (
      <BentoBackground
        src="/assets/Angelic D Planner.png"
        position="object-top"
      />
    ),
  },
  {
    ...
    description:
      "Stay focused, not scattered. Map your week so every day builds toward your bigger goals.",
    href: "/auth/signup",
    cta: "Get started",
  ...
  },
  {
    ...
    description:
      "Turn effort into money. Track income goals and log progress daily.",
    href: "/auth/signup",
    cta: "Get started",
    className: "col-span-3 lg:col-span-1",
  ...
  },
  {
    ...
    description:
      "Built-in systems that keep you on track even when life feels heavy.",
    href: "/auth/signup",
    cta: "Get started",
    className: "col-span-3 lg:col-span-1",
    background: (
      <BentoBackground
        src="/assets/Angelic Bus My Plan Story (1).png"
        position="object-top"
      />
    ),
  },
  {
    ...
    description:
      "Morning and evening rituals that calm your nervous system and ground your day.",
    href: "/auth/signup",
    cta: "Get started",
    className: "col-span-3 lg:col-span-1",
...
export function LandingClient() {
  ...
  return (
    <div
      ref={containerRef}
      className="flex min-h-screen flex-col bg-brand-bg-main text-brand-text overflow-x-hidden"
    >
      {/* ── Hero ── */}
      <div className="relative">
        ...
        >
          ...
          >
            <motion.p
              variants={fadeUp}
              className="mb-4 text-xs font-semibold uppercase tracking-widest text-brand"
            >
            ...
            <motion.p
              variants={fadeUp}
              className="mx-auto mb-3 max-w-2xl text-base leading-relaxed text-brand-muted sm:text-lg"
            >
              Simple, step-by-step systems to help you stay consistent, get
              organized, and finally see real progress.
            </motion.p>

            <motion.p
              variants={fadeUp}
              className="mx-auto mb-10 max-w-xl text-sm text-brand-muted italic"
            >
              Your life doesn't change from thinking about it. It changes when
              you have a system you actually follow.
            </motion.p>
              ...
              <motion.div variants={stagger} className="space-y-1">
                {PAIN_POINTS.map((point, i) => (
                  <motion.div
                    ...
                    className="flex items-start gap-3 py-3 border-b border-brand-accent/20 last:border-0"
                  >
                ...
                <motion.div
                  variants={fadeUp}
                  className="pt-5 border-l-4 border-brand pl-5"
                >
                  <p className="text-sm font-semibold text-brand-text">
                    You don't need more motivation.
                  </p>
                  <p className="font-display italic text-xl text-brand-cta mt-0.5">
                    You need structure.
                  </p>
                </motion.div>
              </motion.div>
            ...
            >
              ...
              >
                {[
                  ...
                  <motion.div
                    key={i}
                    variants={fadeUpDelay(i * 0.07)}
                    className="flex items-start gap-4 p-4 rounded-xl bg-white/5 border border-white/8"
                  >
                    <span className="text-brand-muted text-xs font-mono mt-0.5 shrink-0">
                ...
                <motion.div
                  variants={fadeUp}
                  className="p-4 rounded-xl bg-brand/10 border border-brand/20 mt-2"
                >
                  <p className="text-brand-muted text-sm">
                    You don't follow through, not because you can't…
                  </p>
            ...
            >
              ...
              <motion.div variants={stagger} className="space-y-3">
                {[
                  ...
                  <motion.div
                    key={i}
                    variants={fadeUpDelay(i * 0.06)}
                    className="flex items-center gap-3 p-4 rounded-xl bg-brand-highlight border border-brand-cta/30"
                  >
      ...
      <section
        id="about"
        className="px-6 py-24 bg-brand-bg-main border-t border-brand-accent/20"
      >
        <div className="mx-auto max-w-5xl">
          <Reveal>
            <motion.div
            ...
            >
              ...
              <motion.div variants={stagger} className="space-y-1">
                ...
                <motion.div
                  variants={fadeUp}
                  className="pt-5 border-l-4 border-brand-cta pl-5"
                >
      ...
      <section
        id="why"
        className="px-6 py-24 bg-brand-bg-light border-t border-brand-accent/20"
      >
        <div className="mx-auto max-w-5xl">
          <Reveal>
            <motion.div
            ...
            >
              ...
              >
                {[
                  {
                    label: "Not hustle-based",
                    desc: "Progress without burning out",
                  },
                  {
                    label: "Not overwhelming",
                    desc: "One step at a time, always",
                  },
                  {
                    label: "Built for women rebuilding",
                    desc: "Designed for your real life",
                  },
                  {
                    label: "Structure + emotional stability",
                    desc: "Head and heart, together",
                  },
                  {
                    label: "Real life, not perfect routines",
                    desc: "Works even on hard days",
                  },
                ].map(({ label, desc }, i) => (
                  <motion.div
                    key={i}
        ...
        <Reveal className="mx-auto max-w-2xl text-center space-y-8">
          ...
          <motion.div variants={fadeUp} className="space-y-4">
            ...
            <p className="text-brand-muted leading-relaxed">
              You don't need to have it all figured out. You just need a system
              that helps you take the next step.
            </p>
            <p className="font-semibold text-brand-text">
              Start simple. Start structured. Start now.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div className="space-y-3">
              ...
              <p className="text-xs text-brand-muted">
                Helping women 30+ turn chaos into structure and structure into
                income.
              </p>
            </div>
            <div className="space-y-3">
